...
const float ZOMBIE_TYPE_1_VELOCITY = -0.1;
...
const float ZOMBIE_TYPE_2_VELOCITY = -0.1;
const float ZOMBIE_TYPE_2_DAMAGE = 10;
const float ZOMBIE_TYPE_2_EATING_SPEED = 1;
...
public:
	std::string line_id;
	Zombie(std::string z_type,std::vector<float> options,std::string i , std::string l_i ,float primary_x ,float  primary_y);
